...
export const formSchema = z.object({
  ...
  camera_phone: z.string().min(10, "Введите корректный номер телефона"),
  camera_number: z.string().min(1, "Введите добавочный номер"),
  ...
  emergency_phone: z.string().min(10, "Введите корректный номер телефона"),
  relative_phone: z.string().min(10, "Введите корректный номер телефона"),
